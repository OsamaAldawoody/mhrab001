...
//                mMoveText1TextOutPlaying = false;
        ...
        private void initView(Context context) {
            ...
            setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT, Gravity.RIGHT));
            setPadding(5, 0, 0, 0);

            // Scroll View 1
            LayoutParams sv1lp = new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
            sv1lp.gravity = Gravity.RIGHT|Gravity.CENTER_VERTICAL;
            mScrollView1 = new ScrollView(context);
              String droidkufi = "fonts/droidkufi_regular.ttf";

            Typeface  fontDroidkufi = Typeface.createFromAsset(context.getAssets(), droidkufi);
            ...
            mTextField1.setEllipsize(TextUtils.TruncateAt.MARQUEE);
            mTextField1.setMarqueeRepeatLimit(-1);
            mTextField1.setTextDirection(View.LAYOUT_DIRECTION_RTL);
            mTextField1.setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            mTextField1.setTypeface(fontDroidkufi, Typeface.NORMAL);
            mScrollView1.setTextDirection(View.LAYOUT_DIRECTION_RTL);
